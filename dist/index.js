...
export async function main(overrides = {}) {
    ...
    try {
        ...
        if (!stdin) {
            ...
            deps.log('[prism-hud] Initializing...');
            if (isMacOS) {
                deps.log('[prism-hud] Note: On macOS, you may need to restart Claude Code for the HUD to appear.');
            }
            return;
        }
        ...
        deps.log('[prism-hud] Error:', error instanceof Error ? error.message : 'Unknown error');
    }
}
